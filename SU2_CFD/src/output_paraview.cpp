...
void COutput::SetParaview_ASCII(CConfig *config, CGeometry *geometry, unsigned short val_iZone, unsigned short val_nZone, bool surf_sol) {
  ...
  /*--- Write the header ---*/
  if (surf_sol) Paraview_File << "POINTS "<< nSurf_Poin <<" float64\n";
  else Paraview_File << "POINTS "<< nGlobal_Poin <<" float64\n";
  ...
  if ((config->GetKind_SU2() == SU2_SOL) || (config->GetKind_SU2() == SU2_DOT)) {
    ...
    for (iVar = 0; iVar < nVar_Consv; iVar++) {
      ...
      if ((Kind_Solver == FEM_ELASTICITY) || (Kind_Solver == DISC_ADJ_FEM))
        Paraview_File << "\nSCALARS Displacement_" << iVar+1 << " float64 1\n";
      else
        Paraview_File << "\nSCALARS Conservative_" << iVar+1 << " float64 1\n";
    ...
    if (config->GetWrt_Limiters()) {
      for (iVar = 0; iVar < nVar_Consv; iVar++) {
        ...
        Paraview_File << "\nSCALARS Limiter_" << iVar+1 << " float64 1\n";
        Paraview_File << "LOOKUP_TABLE default\n";
    ...
    if (config->GetWrt_Residuals()) {
      for (iVar = 0; iVar < nVar_Consv; iVar++) {
        ...
        Paraview_File << "\nSCALARS Residual_" << iVar+1 << " float64 1\n";
        Paraview_File << "LOOKUP_TABLE default\n";
    ...
    if ((Kind_Solver == EULER) || (Kind_Solver == NAVIER_STOKES) || (Kind_Solver == RANS)) {
      ...
      Paraview_File << "\nSCALARS Pressure_Coefficient float64 1\n";
      Paraview_File << "LOOKUP_TABLE default\n";
    ...
    if ((Kind_Solver == NAVIER_STOKES) || (Kind_Solver == RANS)) {
      ...
      Paraview_File << "\nSCALARS Laminar_Viscosity float64 1\n";
      Paraview_File << "LOOKUP_TABLE default\n";
      ...
      Paraview_File << "\nSCALARS Skin_Friction_Coefficient_X float64 1\n";
      Paraview_File << "LOOKUP_TABLE default\n";
      ...
      Paraview_File << "\nSCALARS Skin_Friction_Coefficient_Y float64 1\n";
      Paraview_File << "LOOKUP_TABLE default\n";
      ...
      if (nDim == 3) {
        ...
        Paraview_File << "\nSCALARS Skin_Friction_Coefficient_Z float64 1\n";
        Paraview_File << "LOOKUP_TABLE default\n";
    ...
    if (Kind_Solver == RANS) {
      ...
      Paraview_File << "\nSCALARS Eddy_Viscosity float64 1\n";
      Paraview_File << "LOOKUP_TABLE default\n";
    ...
    if (( Kind_Solver == ADJ_EULER         ) ||
      ...
      Paraview_File << "\nSCALARS Surface_Sensitivity float64 1\n";
      Paraview_File << "LOOKUP_TABLE default\n";
    ...
    if  (( Kind_Solver == DISC_ADJ_EULER        ) ||
      ...
      Paraview_File << "\nSCALARS Sensitivity_x float64 1\n";
      Paraview_File << "LOOKUP_TABLE default\n";
      ...
      Paraview_File << "\nSCALARS Sensitivity_y float64 1\n";
      Paraview_File << "LOOKUP_TABLE default\n";
      ...
      if (nDim == 3) {
        Paraview_File << "\nSCALARS Sensitivity_z float64 1\n";
        Paraview_File << "LOOKUP_TABLE default\n";
    ...
    if (Kind_Solver == FEM_ELASTICITY) {
       ...
       if (config->GetDynamic_Analysis() == DYNAMIC) {
         ...
         Paraview_File << "\nSCALARS Acceleration_1 float64 1\n";
         Paraview_File << "LOOKUP_TABLE default\n";
         ...
         for (iPoint = 0; iPoint < nGlobal_Poin; iPoint++) {
          ...
          Paraview_File << "\nSCALARS Acceleration_2 float64 1\n";
          Paraview_File << "LOOKUP_TABLE default\n";
         ...
         Paraview_File << "\nSCALARS Acceleration_3 float64 1\n";
         Paraview_File << "LOOKUP_TABLE default\n";
    ...
    if (nDim == 3) {
     ...
     VarCounter++;
      ...
      Paraview_File << "\nSCALARS Von_Mises_Stress float64 1\n";
      Paraview_File << "LOOKUP_TABLE default\n";
...
void COutput::SetParaview_MeshASCII(CConfig *config, CGeometry *geometry, unsigned short val_iZone, unsigned short val_nZone, bool surf_sol, bool new_file) {
  ...
  if (config->GetKind_SU2() == SU2_SOL) {
    ...
    if ((Kind_Solver == NAVIER_STOKES) || (Kind_Solver == RANS)) {
      ...
      Paraview_File << "\nSCALARS Skin_Friction_Coefficient float64 1\n";
      Paraview_File << "LOOKUP_TABLE default\n";
...
void COutput::WriteParaViewASCII_Parallel(CConfig *config, CGeometry *geometry, CSolver **solver, unsigned short val_iZone, unsigned short val_nZone, bool surf_sol) {
  ...
  /*--- Write the header ---*/
  if (surf_sol) Paraview_File << "POINTS "<< nGlobal_Surf_Poin <<" float64\n";
  else Paraview_File << "POINTS "<< nGlobal_Poin_Par <<" float64\n";
