...
COutput::~COutput(void) {
  ...
  if(turbo){
    ...
    for(iMarker = 0; iMarker< nMarkerTurboPerf; iMarker++){
      ...
      delete [] TotalDensityIn       [iMarker];
      delete [] TotalDensityOut      [iMarker];
      delete [] SoundSpeedIn         [iMarker];
      delete [] SoundSpeedOut        [iMarker];
    ...
    delete [] EntropyIn;
    delete [] EntropyIn_BC;
    delete [] TotalDensityIn;
    delete [] TotalDensityOut;
    delete [] SoundSpeedIn;
    delete [] SoundSpeedOut;
    delete [] EntropyOut;
